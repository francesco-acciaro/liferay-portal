...
boolean hideActionsColumn = (boolean)request.getAttribute("liferay-commerce:accounts-data-set:hideActionsColumn");
int pageSize = (int)request.getAttribute("liferay-commerce:accounts-data-set:pageSize");
boolean showPagination = (boolean)request.getAttribute("liferay-commerce:accounts-data-set:showPagination");
%>